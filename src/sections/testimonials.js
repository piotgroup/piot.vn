...
const data = [
  {
    id: 1,
    logo: uber,
    author: 'Jack Leal - Giám đốc tài chính, Dịch vụ lĩnh vực hóa dầu',
    quote: `“Chúng tôi đã có thể sử dụng PIOT không chỉ như một công cụ dòng tiền mà còn như một công cụ đàm phán với các nhà cung cấp tài chính khác của chúng tôi. Nó có tác động đáng kinh ngạc đến dòng tiền của chúng tôi. "
    ”`,
  },
